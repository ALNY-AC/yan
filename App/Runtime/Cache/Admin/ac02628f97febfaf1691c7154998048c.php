...
<body>
    ...
    <div class="layui-row" style="padding-top:10px">
        ...
        <div class="layui-btn-group">
            <button class="layui-btn layui-btn-sm layui-black" title='添加医院' id="add">
    ...
    <script type="text/html" id="bar1">
        <a class="layui-btn layui-btn-xs layui-black" lay-event="list" data-id='{{d.hosp_id}}' title='管理项目列表' >
            <i class="fa fa-fw fa-list-ul"></i>
        </a>
        <a class="layui-btn layui-btn-xs layui-black" lay-event="edit" data-id='{{d.hosp_id}}' title='编辑' >
            <i class="layui-icon">&#xe642;</i>
        </a>
    ...
    <script type="text/html" id="bar_url">
        ...
        <div class="img-box" data-mtpis='<img src="/yan/{{ d.hosp_url }}" class="img-hover"  alt="">'>
                【图片】
        </div>
    ...
    <script>
        ...
        layui.use(['table', 'form', 'upload'], function () {
            ...
            tableIns = table.render({
                id: 'table'
                , elem: '#table'
                , url: '/yan/index.php/Admin/Use/getListWhere' //数据接口
                , where: {
                    table: 'hosp',
                }
                , response: {
                ...
                , cols: [[ //表头
                    ...
                    , { field: 'hosp_id', title: 'id', width: 100 }
                    , { field: 'hosp_title', title: '医院名', width: 500, edit: 'text', }
            ...
            table.on('tool(table_filter)', function (obj) {
                ...
                if (layEvent === 'edit') {
                    //编辑
                    var url = '/yan/index.php/Admin/Hosp/edit/hosp_id/' + data.hosp_id;
                ...
                if (layEvent === 'list') {
                    ...
                    var url = '/yan/index.php/Admin/Project/showList/hosp_id/' + data.hosp_id + '/type/hosp';
        ...
        */
        $(document).on('click', '#reload', function () {
            ...
            var key = $('#key').val();
            var key_where = 'hosp_id|hosp_title';
            //执行重载
            tableIns.reload({
                page: {
                    curr: 1 //重新从第 1 页s开始
        ...
        $(document).on('click', '#add', function () {
            window.open('/yan/index.php/Admin/Hosp/add');
