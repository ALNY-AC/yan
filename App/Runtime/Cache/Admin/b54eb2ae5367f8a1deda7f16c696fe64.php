...
<body>
    ...
    <script type="text/html" id="bar1">
        <a class="layui-btn layui-btn-xs layui-black" lay-event="show" data-id='{{d.paper_id}}' title='查看' >
                <i class="layui-icon">&#xe615;</i>
        </a>
    ...
    <script>
        ...
        layui.use(['table', 'form', 'upload'], function () {
            ...
            tableIns = table.render({
                ...
                , cols: [[ //表头
                    ...
                    , { field: 'feedback_id', title: 'id', width: 100 }
                    , { field: 'feedback_contact', title: '联系方式', width: 200, }
                    , { field: 'feedback_info', title: '反馈详情', width: 500, }
            ...
            table.on('tool(table_filter)', function (obj) {
                ...
                if (layEvent === 'show') {
                    //编辑
                    var url = '/yan/index.php/Admin/Feedback/show/feedback_id/' + data.feedback_id;
                    window.open(url);
                }
        ...
        */
        $(document).on('click', '#reload', function () {
            ...
            var key = $('#key').val();
            var key_where = 'feedback_id|feedback_title';
            //执行重载
            tableIns.reload({
                page: {
                    curr: 1 //重新从第 1 页s开始
        ...
        $(document).on('click', '#add', function () {
            window.open('/yan/index.php/Admin/Feedback/add');
