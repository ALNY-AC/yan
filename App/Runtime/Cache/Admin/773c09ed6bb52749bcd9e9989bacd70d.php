...
<head>
    ...
    <title>项目列表(<?php echo ($type_title); ?>)</title>
    <!-- css -->
...
<body>
    <div class="page-header">
        <h1>
            <small>项目列表(<?php echo ($type_title); ?>)</small>
        </h1>
    </div>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">项目列表(<?php echo ($type_title); ?>)</li>
    </ol>
    ...
    <script type="text/html" id="bar_url">
        ...
        <div class="img-box" data-mtpis='<img src="/yan/{{ d.project_url }}" class="img-hover"  alt="">'>
                【图片】
        </div>
    ...
    <script>
        ...
        layui.use(['table', 'form', 'upload'], function () {
            ...
            table.on('tool(table_filter)', function (obj) {
                ...
                if (layEvent === 'edit') {
                    //编辑
                    var url = '/yan/index.php/Admin/Project/edit/project_id/' + data.project_id;
                ...
                if (layEvent === 'edit_paper') {
                    //编辑文章
                    var url = '/yan/index.php/Admin/Paper/edit/super_id/' + data.project_id;
        ...
        */
        ...
        $(document).on('click', '#add', function () {
            ...
            window.open('/yan/index.php/Admin/Project/add/super_id/<?php echo ($super_id); ?>/type/<?php echo ($type); ?>');
