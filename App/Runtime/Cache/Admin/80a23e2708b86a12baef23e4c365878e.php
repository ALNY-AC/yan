...
<body>
    ...
    <script type="text/html" id="bar_url">
        ...
        <div class="img-box" data-mtpis='<img src="/yan/{{ d.user_url }}" class="img-hover"  alt="">'>
                【图片】
        </div>
    ...
    <script>
        ...
        layui.use(['table', 'form', 'upload'], function () {
            ...
            tableIns = table.render({
                ...
                , cols: [[ //表头
                    ...
                    , { field: 'user_name', title: '昵称', width: 200, edit: 'text', }
                    , { field: 'level', title: '等级', width: 200, edit: 'text', sort: true }
            ...
            table.on('tool(table_filter)', function (obj) {
                ...
                if (layEvent === 'edit') {
                    //编辑
                    var url = '/yan/index.php/Admin/User/edit/user_id/' + data.user_id;
                ...
                if (layEvent === 'list') {
                    ...
                    var url = '/yan/index.php/Admin/Project/showList/user_id/' + data.user_id + '/type/user';
        ...
        */
        $(document).on('click', '#reload', function () {
            ...
            var key = $('#key').val();
            var key_where = 'user_id|user_title';
            //执行重载
            tableIns.reload({
                page: {
                    curr: 1 //重新从第 1 页s开始
        ...
        $(document).on('click', '#add', function () {
            window.open('/yan/index.php/Admin/User/add');
