...
<body>
    ...
    <div class="o-panel">
        ...
        <div class="o-panel-body">
            ...
            <form class="layui-form">
                <input type="hidden" name='super_id' id='super_id' value="<?php echo ($super_id); ?>">
                <input type="hidden" name='type' id='type' value="<?php echo ($type); ?>">

                <div class="form-group">
                    <label>项目名</label>
                    <input type="text" lay-verify='required' value="<?php echo ($project["project_title"]); ?>" autocomplete="off" class="o-form-control" name="project_title"
                        placeholder="项目名">
                </div>
                <div class="form-group">
                    <label>项目头像</label>
                ...
                <div class="form-group">
                    <label> </label>
                    <img src="/yan/<?php echo ($project["project_head"]); ?>" alt="" id="project_head_img" name="project_head">
                    <input type="hidden" name="project_head" value='<?php echo ($project["project_head"]); ?>' id="project_head">
                </div>

                <div class="form-group">
                    <label>项目简介</label>
                    <textarea cols="30" rows="10" class="o-form-control" name="project_info" placeholder="项目简介（255字以内）"><?php echo ($project["project_info"]); ?></textarea>
                </div>
    ...
    <script src="/yan/Public/Admin/dist/linkage/linkage.js" type="text/javascript" charset="utf-8"></script>
    <script>
        ...
        layui.use(['form', 'upload'], function () {
            ...
            var uploadInst = upload.render({
                elem: '#upload' //绑定元素
                , url: '/yan/index.php/Admin/Use/upFile' //上传接口
                // , accept: 'file' //允许上传的文件类型
                // , exts: 'csv'
                // , auto: false
                , data: {
                    src: '/project/img/',
                    del_src: '<?php echo ($project["project_head"]); ?>'
                }
                , drag: true
                , done: function (res) {
                    //上传完毕回调
                    ...
                    if (res.code == 0) {
                        //成功
                        $('#project_head_img').attr('src', '/yan/' + res.data.src);
        ...
        function addproject(data) {
            ...
            var url = '/yan/index.php/Admin/use/add';
            var obj = {
                table: 'project',
                add: data.field
            };
            var fun = function (res) {
                ...
                if (res.res >= 0) {
                    ...
                    count++;
                    window.location.href = '/yan/index.php/Admin/Project/edit/project_id/' + res.msg.project_id;
